...
//     try {
//       const response = await axios.get(`http://88.222.214.93:8001/filedService/showStage`);
//       setStages(response.data || []);
//     } catch (error) {
//       Alert.alert('Error', 'Unable to fetch stages');
//       console.log('Error fetching stages:', error);
//     }
//   };

//   const handleApproveBtn = async (complaintId, status) => {
//     try {
...
//   const handleStageChange = async (complaintId, stageId) => {
//     try {
//       await handleApproveBtn(complaintId, stageId);
//     } catch (error) {
//       console.log('Error changing stage:', error);
//     }
//   };
...
//         </Text>
//         {item?.Stage[0]?._id === '675aaf9c44c74418017c1dae' ? (
//           <OpenMap longitude={item?.Farmer[0]?.longitude} latitude={item?.Farmer[0]?.latitude} />
//         ) : item?.Stage[0]._id === '675aaf9c44c74418017c1daf' ? <EntypoIcon name='squared-cross' color='red' size={25} />  : ' '}
//       </View>
//       <Text style={styles.infoText}>
//         <Text style={styles.label}>Tracking ID:</Text> {item.trackingId}
//       </Text>
...
//         {stages.length > 0 && (
//           <Picker
//             selectedValue={item?.Stage[0]?._id}
//             style={styles.picker}
//             onValueChange={(value) => handleStageChange(item._id, value)}
//           >
//             {stages.map((stage) => (
//               <Picker.Item key={stage._id} label={stage.stage} value={stage._id} />
//             ))}
//           </Picker>
//         )}
//       </View>
...
//           <>
//             <TouchableOpacity
//               onPress={() => handleApproveBtn(item._id, '675aaf9c44c74418017c1daf')}
//               style={styles.declineButton}
//             >
//               <Text style={styles.buttonText}>Decline</Text>
//             </TouchableOpacity>
//             <TouchableOpacity
//               onPress={() => handleApproveBtn(item._id, '675aaf9c44c74418017c1dae')}
//               style={styles.approveButton}
//             >
//               <Text style={styles.buttonText}>Approve</Text>
//             </TouchableOpacity>
