...
//       } catch (error) {
//         Alert.alert('Error', JSON.stringify(error.response?.data?.message || 'Failed to fetch items'));
//       }
//     };
...
//       _id: allItems.find((i) => i.itemName === item)._id,
//     }));

//     console.log('Selected Data:', selectedData);
//     Alert.alert('Success', JSON.stringify(selectedData, null, 2));
//   };
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.put(
        'http://88.222.214.93:5000/service-person/update-holding-items',
        { items: selectedData }
      );
