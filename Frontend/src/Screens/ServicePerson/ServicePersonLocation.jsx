...
const styles = StyleSheet.create({
  ...
  buttonGroup: { flexDirection: 'row', justifyContent: 'center', marginBottom: 20 },
  button: { padding: 15, borderRadius: 5, alignItems: 'center', justifyContent: 'center', width: '80%' },
  punchInBtn: { backgroundColor: '#4CAF50' },
  punchOutBtn: { backgroundColor: '#f44336' },
  buttonText: { color: 'white', fontWeight: 'bold' },
  successMessage: { color: '#4CAF50', textAlign: 'center', marginTop: 10 },
  errorMessage: { color: '#f44336', textAlign: 'center', marginTop: 10 },
  statusText: { textAlign: 'center', marginTop: 10, fontSize: 16, color: '#555', marginBottom: 20 },
  sectionTitle: { fontSize: 18, fontWeight: 'bold', marginBottom: 10, color: '#333' },
  historyContainer: { flex: 1, marginTop: 10 },
  historyItem: { backgroundColor: '#f8f8f8', padding: 15, borderRadius: 8, marginBottom: 10, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  historyDate: { fontWeight: 'bold', color: '#333' },
  historyDetails: { alignItems: 'flex-end' },
  historyStatus: { color: '#555', fontSize: 14 },
  historyWarning: { color: '#f44336', fontSize: 14, marginTop: 5 },
  noHistoryText: { textAlign: 'center', color: '#888', marginTop: 20 },
});
