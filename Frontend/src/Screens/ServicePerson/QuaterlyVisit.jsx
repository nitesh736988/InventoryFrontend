...
//       await axios.post('http://88.222.214.93:8001/filedService/addSurvey', formData);
...
//           Alert.alert('Error', 'Camera error occurred.');
//           return;
//         }
...
//   dropdown: { height: 50, backgroundColor: '#fff', borderWidth: 1, borderColor: '#ccc', marginBottom: 20, borderRadius: 5 },
//   submitButton: { backgroundColor: '#000', padding: 15, borderRadius: 30, alignItems: 'center' },
