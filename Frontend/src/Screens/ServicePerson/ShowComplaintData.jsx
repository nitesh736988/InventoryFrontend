...
//   const handleSelectionData = value => {
//     setSelected(value);
//   };
...
//     if (option === 'Yes') {
//       // Open the item selection section
...
const ShowComplaintData = ({ route }) => {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      try {
        const response = await axios.get(
          `${API_URL}/service-person/show-holding-items`,
        );
