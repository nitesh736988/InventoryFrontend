...
//     console.log("Image cut option selected for:", uri);
//   };
...
//                     <Text style={styles.cutButtonText}>✂️</Text>
//                   </TouchableOpacity>
//                 </View>
//               ))}
//           </ScrollView>
...
// const verifyPhotoWithAI = async (photoUri, category) => {
//   try {
//     // Replace with your AI service endpoint
//     const apiUrl = 'https://your-ai-service.com/verify-photo';
...
//       image: base64Image,
//       category, // Send the category for verification
//     });

//     // Assuming the API returns { isValid: true/false, message: "Description" }
//     return response.data;
//   } catch (error) {
//     console.log('Error verifying photo:', error.message);
...
//             // Verify the photo with AI
//             const verificationResult = await verifyPhotoWithAI(
//               resizedImage.uri,
//               category,
//             );
...
//               Alert.alert(
//                 'Invalid Photo',
//                 verificationResult.message || 'The photo does not match the expected category.',
//               );
//               return;
//             }
...
//             setPhotos((prevPhotos) => [...prevPhotos, resizedPhoto]);
//           } catch (error) {
//             console.log('Error resizing or verifying image:', error.message);
