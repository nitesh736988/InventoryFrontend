...
const RepairHistory = () => {
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      setOrders(response.data.allRepairItemData);
      setFilteredOrders(response.data.allRepairItemData);
    } catch (error) {
  ...
  const renderOrderItem = ({item}) => (
    <View key={item._id} style={styles.card}>
      ...
      <Text style={styles.infoText}>
        <Text style={styles.titleText}>
          Repaired: <Text style={styles.dataText}>{item.repaired}</Text>
        </Text>
      </Text>
      ...
      {item.repaired && (
        <Text style={styles.infoText}>
          <Text style={styles.titleText}>
            Repaired By: <Text style={styles.dataText}>{item.repairedBy}</Text>
          </Text>
        </Text>
      )}
