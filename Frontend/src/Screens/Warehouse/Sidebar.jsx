          ...
          {activeTab === 'Galo' ? (
            ...
            <>
              ...
              {expandedSections.mhHistory && (
                <>
                  <TouchableOpacity
                    onPress={() => navigateAndHighlight('InstallationW2W')}
                    style={styles.subOptionButton}>
                    <Text style={styles.subOptionText}>Installation W2W</Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    onPress={() => navigateAndHighlight('ApprovalIncomingInstallation')}
                    style={styles.subOptionButton}>
                    <Text style={styles.subOptionText}> Approval Incoming Installation</Text>
                  </TouchableOpacity>

                  <TouchableOpacity
                    onPress={() => navigateAndHighlight('ApprovalOutgoingInstallation')}
                    style={styles.subOptionButton}>
                    <Text style={styles.subOptionText}> Approval Outgoing Installation</Text>
                  </TouchableOpacity>
                </>
              )}
              ...
              {expandedSections.mhHistorydata && (
                <>
                  <TouchableOpacity
                    onPress={() => navigateAndHighlight('InstallationOutgoingHistory')}
                    style={styles.subOptionButton}>
                    <Text style={styles.subOptionText}>Show Outgoing History</Text>
                  </TouchableOpacity>

                  <TouchableOpacity
                    onPress={() => navigateAndHighlight('InstallationIncomingHistory')}
                    style={styles.subOptionButton}>
              ...
              <TouchableOpacity
                ...
                style={styles.optionButton}>
                <View style={styles.optionHeader}>
                  <Text style={styles.optionText}>Installation Form Fill</Text>
                  <Icon
              ...
              {expandedSections.mhformfill && (
                <>
                  <TouchableOpacity
                    onPress={() => navigateAndHighlight('UpperIncomingItems')}
                    style={styles.subOptionButton}>
                    <Text style={styles.subOptionText}>Upper Incoming Items</Text>
                  </TouchableOpacity>

                   <TouchableOpacity
                    onPress={() => navigateAndHighlight('OutgoingInstallation')}
                    style={styles.subOptionButton}>
                    <Text style={styles.subOptionText}>Outgoing Installation</Text>
                  </TouchableOpacity>
