      ...
      >
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          <View style={styles.modalContainer}>
            ...
            >
              <Picker.Item key={formData.fromWarehouse} label={formData.fromWarehouse} value={formData.fromWarehouse} />
            </Picker>
            ...
            <TouchableOpacity style={styles.button} onPress={() => setFormData((prevData) => ({ ...prevData, modalVisible: false }))}>
