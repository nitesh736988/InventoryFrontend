...
//           <Text style={styles.switchButtonText}>New Installation</Text>
//         </TouchableOpacity>
//       </View>
...
//           <Text style={styles.cardTitle}>New Installation</Text>
//           <Text style={styles.cardDetails}>
//             Add content for "New Installation" here.
//           </Text>
//         </View>
//       )}
//     </ScrollView>
  ...
  return (
    <ScrollView
      ...
      {activeCard === 'Service' ? (
        ...
        <View style={styles.card}>
          <Text style={{ ...styles.cardDetails, color: '#000' }}>
            ItemName: {newInstallationData?.itemName}
          </Text>
          <Text style={{ ...styles.cardDetails, color: '#000' }}>
            Quantity: {newInstallationData?.quantity}
          </Text>
        </View>
      )}
    </ScrollView>
