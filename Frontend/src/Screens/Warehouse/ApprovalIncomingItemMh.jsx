...
//             try {
//                 const response = await axios.get("http://88.222.214.93:5000/warehouse-admin/show-incoming-item");
...
// export default ShowIncomingItemMh;
  ...
  const fetchOutgoingHistory = async () => {
    try {
      ...
      const response = await axios.get(
        'http://88.222.214.93:5000/warehouse-admin/show-incoming-item',
      );
      if (response.data.success) {
        setOutgoingHistory(response.data.data);
      } else {
  ...
  const handleApprove = async (transferId) => {
    try {
      ...
      const response = await axios.put(
        `http://88.222.214.93:5000/warehouse-admin/approve-incoming-item`,
        requestData,
        {
          headers: {
