...
const EditServicePerson = ({ route }) => {
  const { _id, name, email, contact, longitude, latitude } = route.params;
  ...
  const handleSubmit = async () => {
    setLoading(true);
    try {
      const response = await axios.put(`${API_URL}/admin/update-service-person`, {
        _id: formData.servicePersonId,
        name: formData.name,
      ...
      Alert.alert('Error', 'An error occurred while updating service person');
