...
//           <Picker selectedValue={sourceType} onValueChange={setSourceType} style={styles.picker}>
...
//         <TextInput style={styles.input} value={waterLevel} onChangeText={setWaterLevel} keyboardType="numeric" />

//         <Text style={styles.label}>Pump Head:</Text>
//         <View style={styles.pickerContainer}>
//           <Picker selectedValue={pumpHead} onValueChange={setPumpHead} style={styles.picker}>
